...
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh.zip > /dev/null 2>&1
...
sleep 1
cd || exit
wget https://github.com/81dR4uL1k/pweb/raw/main/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
cd /bin || exit
wget https://github.com/81dR4uL1k/pweb/raw/main/userteste.sh
wget https://github.com/81dR4uL1k/pweb/raw/main/autobackup.sh
