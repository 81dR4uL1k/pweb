...
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/gestorssh18.zip > /dev/null 2>&1
...
function inst_db { 
cd || exit
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/bdgestorssh.sql > /dev/null 2>&1
sleep 1
...
function tst_bkp {
cd /bin || exit
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/userteste.sh
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/autobackup.sh
