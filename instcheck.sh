...
sleep 5
cd /bin || exit
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/chuser > /dev/null 2>&1
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/userscheck > /dev/null 2>&1
...
wget https://github.com/81dR4uL1k/pweb/raw/main/gestorssh/checkuser.py > /dev/null 2>&1
...
echo ""
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mWHATSAPP\033[1;31m): \033[1;37m@5581988490151\033[0m"
